 ...
 * @since 9
 */
public class ListCellDebugSkin<T> extends CellSkinBase<ListCell<T>> {
     ...
     */
    public ListCellDebugSkin(ListCell<T> control) {
        super(control);
...
//        control.setInputMap(behavior.getInputMap());
    ...
    /** {@inheritDoc} */
    @Override public double computePrefHeight(double width, double topInset, double rightInset, double bottomInset, double leftInset) {
        prefCounter++;
