...
/**
 * Sanity: is this still passing when showing (vs. simple replace?) - not all,
 * some are leaking when in scene.
 * FIXME: file issue!
 *
...
public class SkinMemoryLeakShowingTest {
...
//------------ parameters
    ...
    public SkinMemoryLeakShowingTest(Class<Control> controlClass) {
