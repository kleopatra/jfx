...
/**
 * Test memory leaks on switching skins.
 * From choicebox fix branch.
 */
...
//        controls.removeAll(leaking);
        return asArrays(controls);
    }

    public SkinMemoryLeakTest(Class<Control> control) {
